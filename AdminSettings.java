...
public class AdminSettings extends JPanel {
    ...
    public AdminSettings(AdminMainFrame adminMainFrame) {
        ...
        leftSideHolder.setLayout(new BorderLayout()); 
        leftSideHolder.setOpaque(false);

        // Top part: leftWrapper
        ...
        backupPanel.setBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY)); 
