...
public class StaffTopNavBar extends JPanel {

    private StaffMainFrame mainFrame;
    private JLabel overviewLabel, inventoryLabel, settingsLabel;
    private JLabel accountName;
    private JButton logoutButton;
    private JPanel topNav;
    private JLabel selectedLabel;

    public StaffTopNavBar(StaffMainFrame mainFrame) {
        ...
        overviewLabel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (mainFrame != null) mainFrame.showPanel(mainFrame.staffOverview);
                setSelectedNavLabel(overviewLabel);
            }
        });
        inventoryLabel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (mainFrame != null) mainFrame.showPanel(mainFrame.staffInventory);
                setSelectedNavLabel(inventoryLabel);
            }
        });
        settingsLabel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (mainFrame != null) mainFrame.showPanel(mainFrame.staffSettings);
    ...
    private void setSelectedNavLabel(JLabel label) {
        ...
        selectedLabel = label;
                ...
                frame.add(new StaffTopNavBar(new StaffMainFrame()));
